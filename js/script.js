...
function createMatrix(n){
	...
	console.log("grid&");
	//grid.setAttribute("class", "matrixStyle");
    grid.style.width = (40*n).toString() + "px";
     ...
     //header1.setAttribute("class", "headers");
     //header1.style.width = (40*n).toString() + "px";
     ...
     for(var i = 0; i<n; i++)
		{		 
		 ...
		 //tr.setAttribute("class", "matrixStyle");
 ...
 function editMatrix(e)
	  {	     
		...
		//  document.getElementById("test").value = "("+id_i+"; "+id_j+")";
